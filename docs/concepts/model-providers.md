...
- CLI helpers: `openclaw-cn onboard`, `openclaw-cn models list`, `openclaw-cn models set <provider/model>`.
...
- CLI: `openclaw-cn onboard --auth-choice openai-api-key`
...
- CLI: `openclaw-cn onboard --auth-choice token` (paste setup-token) or `openclaw-cn models auth paste-token --provider anthropic`
...
- CLI: `openclaw-cn onboard --auth-choice openai-codex` or `codex-cli`
...
- CLI: `openclaw-cn onboard --auth-choice opencode-zen`
...
- CLI: `openclaw-cn onboard --auth-choice gemini-api-key`
...
- Antigravity OAuth is shipped as a bundled plugin (`google-antigravity-auth`, disabled by default).
  - Enable: `openclaw-cn plugins enable google-antigravity-auth`
  - Login: `openclaw-cn models auth login --provider google-antigravity --set-default`
- Gemini CLI OAuth is shipped as a bundled plugin (`google-gemini-cli-auth`, disabled by default).
  - Enable: `openclaw-cn plugins enable google-gemini-cli-auth`
  - Login: `openclaw-cn models auth login --provider google-gemini-cli --set-default`
...
- CLI: `openclaw-cn onboard --auth-choice zai-api-key`
...
- CLI: `openclaw-cn onboard --auth-choice ai-gateway-api-key`
...
- CLI: `openclaw-cn onboard --auth-choice synthetic-api-key`
...
openclaw-cn models set opencode/claude-opus-4-5
