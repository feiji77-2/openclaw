...
```bash
openclaw-cn onboard --auth-choice zai-api-key
# or non-interactive
openclaw-cn onboard --zai-api-key "$ZAI_API_KEY"
```
...
- GLM models are available as `zai/<model>` (example: `zai/glm-5`, `zai/glm-4.7`).
