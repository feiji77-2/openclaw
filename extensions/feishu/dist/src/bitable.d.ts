...
export declare function batchCreateRecords(
  client: ReturnType<typeof createFeishuClient>,
  appToken: string,
  tableId: string,
  records: Array<{
...
export declare function batchUpdateRecords(
  client: ReturnType<typeof createFeishuClient>,
  appToken: string,
  tableId: string,
  records: Array<{
...
export declare function listBitableTables(
  client: ReturnType<typeof createFeishuClient>,
  appToken: string,
  pageSize?: number,
  pageToken?: string,
...
export declare function createBitableTable(
  client: ReturnType<typeof createFeishuClient>,
  appToken: string,
  name: string,
  fields?: Array<{
...
export declare function createBitableField(
  client: ReturnType<typeof createFeishuClient>,
  appToken: string,
  tableId: string,
  fieldName: string,
...
export declare function createBitableView(
  client: ReturnType<typeof createFeishuClient>,
  appToken: string,
  tableId: string,
  viewName: string,
...
export declare function listBitableDashboards(
  client: ReturnType<typeof createFeishuClient>,
  appToken: string,
  pageSize?: number,
  pageToken?: string,
