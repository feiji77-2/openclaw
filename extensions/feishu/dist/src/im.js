  ...
  api.registerTool(
    {
      ...
      label: "飞书 - 获取历史消息",
      description:
        "获取指定群聊的历史消息列表。可指定时间范围和排序方式。返回消息内容、发送者、时间等信息。",
