...
export declare function createCalendarEvent(
...
export declare function getCalendarEvent(
  client: ReturnType<typeof createFeishuClient>,
  calendarId: string,
  eventId: string,
): Promise<{
...
export declare function updateCalendarEvent(
  client: ReturnType<typeof createFeishuClient>,
  calendarId: string,
  eventId: string,
  updates: {
...
export declare function deleteCalendarEvent(
  client: ReturnType<typeof createFeishuClient>,
  calendarId: string,
  eventId: string,
): Promise<{
...
export declare function listCalendarEvents(
  client: ReturnType<typeof createFeishuClient>,
  calendarId: string,
  startTime?: string,
  endTime?: string,
...
export declare function addEventAttendees(
  client: ReturnType<typeof createFeishuClient>,
  calendarId: string,
  eventId: string,
  attendees: Array<{
...
export declare function queryFreebusy(
  client: ReturnType<typeof createFeishuClient>,
  timeMin: string,
  timeMax: string,
  userIds: string[],
