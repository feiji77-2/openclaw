...
/** Get task by GUID */
export declare function getTask(
  client: ReturnType<typeof createFeishuClient>,
  taskGuid: string,
): Promise<{
  task: {
...
/** Update a task */
export declare function updateTask(
  client: ReturnType<typeof createFeishuClient>,
  taskGuid: string,
  updates: {
    summary?: string;
...
export declare function addTaskMembers(
  client: ReturnType<typeof createFeishuClient>,
  taskGuid: string,
  memberIds: string[],
  role?: string,
...
export declare function addTaskReminder(
  client: ReturnType<typeof createFeishuClient>,
  taskGuid: string,
...
/** List tasks */
export declare function listTasks(
  client: ReturnType<typeof createFeishuClient>,
  pageSize?: number,
  pageToken?: string,
): Promise<{
...
export declare function addTaskComment(
  client: ReturnType<typeof createFeishuClient>,
  taskGuid: string,
  content: string,
): Promise<{
